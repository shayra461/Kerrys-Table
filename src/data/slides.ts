...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: "🍗", name: "Protein", desc: "Muscle repair and growth", color: "green" },
      { icon: "🥑", name: "Healthy Fats", desc: "Brain & hormone function", color: "orange" },
      { icon: "🥬", name: "Vitamins & Minerals", desc: "Overall health & immunity", color: "green" },
      { icon: "💧", name: "Water", desc: "Hydration & digestion", color: "orange" },
    ],
  },
  {
    kind: "balanced",
